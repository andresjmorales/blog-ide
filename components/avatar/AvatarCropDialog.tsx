  ...
  return (
    <div className="fixed inset-0 z-[80] flex items-center justify-center p-4">
      ...
      <div
        ...
        className="relative z-10 w-full max-w-sm rounded-lg border border-border bg-background p-4 shadow-lg space-y-3"
      >
        ...
        <div
          className="relative mx-auto overflow-hidden touch-none select-none rounded-md cursor-grab active:cursor-grabbing bg-panel"
          style={{
